...
| [#22 Add local results UI for AI inspection output](https://github.com/thomassuedbroecker/simple_kafka_example/issues/22) | Closed | `src/banking_ai/results_ui.py`, `scripts/start_results_ui.sh`, `tests/test_results_ui.py`, `README.md`, `docs/traceability.md` | `7dc3ea2` |
